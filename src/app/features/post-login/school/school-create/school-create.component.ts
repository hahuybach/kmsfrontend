...
export class SchoolCreateComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.saveSchoolForm = this.formBuilder.group({
            schoolName: ['', [NoWhitespaceValidator(), Validators.maxLength(254)], [this.validateSchoolNameUnique.bind(this)]],
            exactAddress: ['', [NoWhitespaceValidator(), Validators.maxLength(254)]],
        ...
        const saveSchoolRequest = {
            ...
            account: {
                ...
                user: {
                    ...
                    dob: tuiDayToDate(this.saveSchoolForm.value.dob),
    ...
    confirm() {
        this.isSubmitted = true;
        console.log(this.saveSchoolForm);
        if (!this.saveSchoolForm.invalid) {
